...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='E:/pythonproject/yolov8-20230904/yolov8-main/ultralytics/yolo/v8/detect/yolov8-slimneck.yaml', help='model.yaml path')
    parser.add_argument('--weight', type=str, default='', help='pretrained model path')
    parser.add_argument('--cfg', type=str, default='E:/pythonproject/yolov8-20230904/yolov8-main/ultralytics/yolo/cfg/default.yaml', help='hyperparameters path')
    parser.add_argument('--data', type=str, default='E:/pythonproject/yolov8-20230904/yolov8-main/ultralytics/yolo/v8/detect/datasets/crocodile/data.yaml', help='data yaml path')
